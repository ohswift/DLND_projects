...
def discriminator(images, reuse=False, alpha=1.0, hidden_layer_size=128):
    """
...
def generator(z, out_channel_dim, is_train=True, alpha=1.0):
    """
...
def model_loss(input_real, input_z, out_channel_dim, alpha=1.0):
    """
...
def show_generator_output(sess, n_images, input_z, out_channel_dim, image_mode, alpha=1.0):
    """
...
def train(epoch_count, batch_size, z_dim, learning_rate, beta1, get_batches, data_shape, data_image_mode, alpha=1.0):
    """
    Train the GAN
...
#                     losses.append((train_loss_d, train_loss_g))
                if steps % show_every == 0:
                    show_generator_output(sess, 1, input_z, channel, data_image_mode, alpha=alpha)
        # show last one...
        show_generator_output(sess, 1, input_z, channel, data_image_mode, alpha=alpha)
...
learning_rate = 0.001
beta1 = 0.5
alpha = 1.0   # leaky relu, not work well...
