...
def process_decoder_input(target_data, target_vocab_to_int, batch_size):
    ...
    decode_input = tf.concat([tf.fill([batch_size, 1], target_vocab_to_int['<GO>']), ending], 1)
...
def decoding_layer(dec_input, encoder_state,
    ...
    dec_output, dec_state = tf.nn.dynamic_rnn(dec_cell, dec_embed_input, sequence_length=target_sequence_length, dtype=tf.float32)
...
def seq2seq_model(input_data, target_data, keep_prob, batch_size,
    ...
    output = decoding_layer(dec_input, enc_state, 
